...
from simple_event_lib import SimpleEventLib
from simple_event_lib import SimpleEvent
...
class SimpleEventApp(app_manager.RyuApp):
    ...
    _CONTEXTS = {'evlib': SimpleEventLib}
    ...
    @set_ev_cls(SimpleEvent, MAIN_DISPATCHER)
